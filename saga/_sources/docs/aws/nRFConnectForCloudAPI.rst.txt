...
To use nRF Connect for Cloud's geolocation API, configure your API key and enable the API using the CLI and redeploy the stack using the following commands:
