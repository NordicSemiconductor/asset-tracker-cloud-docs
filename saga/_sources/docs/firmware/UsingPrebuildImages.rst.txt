...
You can use the pre-build firmware released on the `Cat Tracker firmware project page <https://github.com/NordicSemiconductor/asset-tracker-cloud-firmware/releases>`_ to connect to your own AWS account **if it is in the same region as our environment** (currently `eu-west-1`).
