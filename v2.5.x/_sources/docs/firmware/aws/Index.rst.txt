...
The `firmware GitHub repository <https://github.com/NordicSemiconductor/asset-tracker-cloud-firmware-aws>`_ provides an example for using the application as an out-of-tree development copy.
