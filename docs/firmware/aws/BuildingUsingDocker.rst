...
Then, follow the :ref:`configuration instructions for the firmware <aws-firmware-configuration>` and update the :file:`prj.conf` file and the :file:`overlay-debug.conf` file.
