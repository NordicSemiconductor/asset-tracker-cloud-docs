...
.. note::
    ...
    This is an advanced topic for those who want to further develop and customize the Asset Tracker Example according to their needs.
    See the `GitHub project page of the Asset Tracker Example for AWS <https://github.com/NordicSemiconductor/asset-tracker-cloud-aws-js/>`_ , for an implementation of the process outlined in this section.
