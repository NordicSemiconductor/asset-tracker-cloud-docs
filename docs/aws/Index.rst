...
The project also provides a description of the available (and implemented) features in a folder called `features <https://github.com/NordicSemiconductor/asset-tracker-cloud-aws-js/tree/saga/features>`_ which are used to continuosly verify the implementation using :ref:`Continuous Integration <aws-continuous-integration>`.
