...
You need a development environment with `Git <https://git-scm.com/>`_, `jq <https://stedolan.github.io/jq/>`_, the `LTS release candidate of Node.js <https://nodejs.org/en/about/releases/>`_ (current LTS release is version 16), and `the current stable release of npm (version 8) <https://github.blog/changelog/2021-10-07-npm-cli-upgraded-to-version-8/>`_.
